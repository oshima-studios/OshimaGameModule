...
namespace Oshima.FunGame.OshimaModules.Skills
{
    ...
    /**
     * 熵灭极诣 = 攻击力提升+普攻自残
     * 千羽瞬华 = 攻击力+物理穿透+闪避率提升，减少普攻硬直，强化普攻，减少心灵之弦CD
     * 咒怨洪流 = 普攻转为魔法伤害，可以普攻多个目标，护甲+魔抗提升，减少蚀魂震击CD
     * 三相灵枢 = 强化灵能反射，并在触发灵能反射时回复能量
     * 变幻之心 = 根据双生流转的模式触发回血+吸血或者魔法伤害加成
     * 零式灭杀 = 提升暴击率和暴击伤害、物理穿透
     * 绝对领域 = 免疫所有伤害，时间型；起步消耗100能量，每10能量额外时间
     * 残香凋零 = 多目标魔法伤害，伤害量基于敌人能量值
     * 宿命时律 = 护甲+魔抗提升，普攻转为魔法伤害，减少普攻硬直，强化普攻
     * 极寒渴望 = 获得吸血，强化累积之压
     * 身心一境 = 力量+敏捷提升
     * 饕餮盛宴 = 获得吸血
     * 樱花无双击 = 单体伤害+生命偷取
     ...
     * 宿命之潮 = 二选一：加速生命回复，攻击力提升，受到伤害提升，造成伤害后额外造成100%重伤；极致加速生命回复，提供友方生命回复，嘲讽所有敌人
     * 神之因果 = 改变全局法则，回合型
     */
     ...
     * 心灵之弦 = 减少普攻硬直，普攻时额外普攻一次，第二次伤害减半
     * 蚀魂震击 = 造成魔法伤害时眩晕目标，对处于控制态的敌人造成额外伤害
     * 灵能反射 = 一定次数内释放魔法不会进入硬直，魔法命中后获得额外能量并减少所有技能CD
     * 双生流转 = 根据当前生命值比例将基础智力转为额外力量或还原，力量模式造成伤害必定暴击，智力模式获得暴击+闪避+魔抗提升
     * 零式崩解 = 暴击伤害提升
     * 少女绮想 = 每经过一段时间，获得伤害加成，造成伤害后减少加成总量的一部分，受到伤害会清零
     * 暗香疏影 = 对一半以下能量的敌人造成额外伤害并削减他们的能量
